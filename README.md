...
Steem Philippines, also known as SteemPH is an organization focused on growing the Filipino Steemit Blogging Community through support and positivity and empowerment. The goal is to also help spread awareness of Steemit, Utopian.io, and other technologies and applications built on the Steem blockchain across the various regions in the Philippines where we believe the power of the Steem blockchain can do the most good.

As we continue to grow, our mission is to provide tools and resources which will help the community grow and help them better understand and utilize the technology they have available to them to prosper, grow, and drive awareness to others in the community.

This Homepage is a resource that will help our community grow and serve as a place where all community members can go for information and support.  The project is constantly evolving based on the needs of the community and is an open-source tool which we would like to seek help in developing.

Below are the Installation Instructions to install <a href ="https://github.com/steemit/condenser">Condenser</a> - the back-end components for the website
